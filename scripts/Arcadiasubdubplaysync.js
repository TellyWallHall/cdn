            ...
            switch (message.MessageType) {
                ...
                case "ForceKeepAlive":
                    if (this.websocket?.readyState === WebSocket.OPEN) {
                        this.websocket.send(JSON.stringify({ MessageType: "KeepAlive" }));
                    }
                    break;
            }
        } catch (e) {
