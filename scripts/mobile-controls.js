...
let crouch2Button = createTouchButton("crouch2Button", "inMenu");
    crouch2Button.style.cssText = "left:14vh;bottom:12vh;"
    crouch2Button.addEventListener("touchstart", function(e){
        ...
        window.crouchTimer = setTimeout(function(e) { // Allows us to lock the button after a long press
            ...
            crouch2Button.classList.toggle('active');
        }, 1);
    }, false);

    crouch2Button.addEventListener("touchend", function(e) {
        if(!window.crouchLock) {
            keyEvent("shift", "keyup")
            crouch2Button.classList.remove('active');
            window.crouchLock = false
        }
        clearTimeout(window.crouchTimer);
    }, false);
    document.body.appendChild(crouch2Button);
...
keyEvent("shift", "keydown"); // Sometimes shift gets stuck on, which interferes with item manipulation in GUI's
    ...
    selectButton.addEventListener("touchstart", function(e){keyEvent("c", "keydown")}, false);
    selectButton.addEventListener("touchend", function(e){keyEvent("c", "keyup")}, false);
    document.body.appendChild(selectButton);
    let scrollUp2Button = createTouchButton("scrollUp2Button", "inMenu");
    scrollUp2Button.classList.add("smallMobileControl");
    scrollUp2Button.style.cssText = "right:6.6vh;bottom:0vh;"
    scrollUp2Button.addEventListener("touchstart", function(e){wheelEvent(canvas, -10)}, false);
    document.body.appendChild(scrollUp2Button);
    let scrollDown2Button = createTouchButton("scrollDown2Button", "inMenu");
    scrollDown2Button.classList.add("smallMobileControl");
    scrollDown2Button.style.cssText = "right:25.8vh;bottom:0vh;"
    scrollDown2Button.addEventListener("touchstart", function(e){wheelEvent(canvas, 10)}, false);
    document.body.appendChild(scrollDown2Button);
